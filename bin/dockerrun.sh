...
yum install -y dialog iproute libselinux-python locales openssh-clients openssh-server python-minimal sudo systemd
...
# Add vagrant user
adduser --shell /bin/bash --home /home/vagrant vagrant
